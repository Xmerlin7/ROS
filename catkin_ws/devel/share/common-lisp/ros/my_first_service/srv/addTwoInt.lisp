...
(cl:in-package my_first_service-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <addTwoInt-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'addTwoInt-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_first_service-srv:<addTwoInt-request> is deprecated: use my_first_service-srv:addTwoInt-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <addTwoInt-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_first_service-srv:a-val is deprecated.  Use my_first_service-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <addTwoInt-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_first_service-srv:b-val is deprecated.  Use my_first_service-srv:b instead.")
  (b m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<addTwoInt-request>)))
  ...
  "my_first_service/addTwoIntRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'addTwoInt-request)))
  "Returns string type for a service object of type 'addTwoInt-request"
  "my_first_service/addTwoIntRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <addTwoInt-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'addTwoInt-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_first_service-srv:<addTwoInt-response> is deprecated: use my_first_service-srv:addTwoInt-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <addTwoInt-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_first_service-srv:sum-val is deprecated.  Use my_first_service-srv:sum instead.")
  (sum m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<addTwoInt-response>)))
  ...
  "my_first_service/addTwoIntResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'addTwoInt-response)))
  "Returns string type for a service object of type 'addTwoInt-response"
  "my_first_service/addTwoIntResponse")
